<div class="page-header navbar navbar-fixed-top">
    ...
    <div class="page-header-inner ">
        ...
        <div class="page-actions">
            <div class="btn-group">
                <span style="color:#fff"><h3 style="margin-top:0px; font-weight:800">Selamat Datang di Halaman Admin</h3></span>
            </div>
        </div>
        <!-- END PAGE ACTIONS -->
        <!-- BEGIN PAGE TOP -->
            ...
            <div class="top-menu">
                <ul class="nav navbar-nav pull-right">
                    ...
                    <li class="dropdown dropdown-user dropdown-light">
                        <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
                            <span class="username username-hide-on-mobile uppercase"> <?php echo $this->session->userdata(base_url().'user_username'); ?> </span>
