    ...
    public function ajax_list() {
        ...
        *
        ...
        if (!empty($search)) {
            ...
            $query .= " OR (replace(pemilik, '''', '')) LIKE '%".strtolower($s_search)."%' ";
        ...
        foreach ($data as $d) {
            ...
            // }
                ...
                $data_ = $this->m_base->get_data('t_bahanpoklahsar', array('poklahsar_id'=>$id));
                $ar_olahan = [];
                $x = 0;
            ...
            $r[2] = $d->pemilik.'<br>' .'<b>'.$d->hp_poklahsar.'</b>';
            $r[3] = $d->alamat_poklahsar;
            $r[4] = !empty($str_fitur) ? $str_fitur : '-';
            $r[5] = $edit.$delete;
            array_push($result, $r);
        }
