...
<div class="page-wrapper-row full-height">
                                ...
                                <div class="portlet light portlet-fit ">
                                    <div class="portlet-title">
                                        ...
                                        <div class="form-inline">
                                          ...
                                          <button type="submit" id="btn_cari" class="btn btn-warning">Rute</button>
                                        </div>
                                    <div id="map" class="c-content-contact" style="height: 615px;"></div>
                                  </div>
                              </div>
                              <div class="col-md-3">
    ...
    <script type="text/javascript">
      ...
      var latlng = new google.maps.LatLng(-7.0551, 112.9535);
       ...
       //  zoom:10,
        ...
        <?php foreach ($get_data->result() as $a): ?>
            ...
            var marker= new google.maps.Marker({
             ...
             marker.setIcon({ url: "<?php echo base_url() ?>/assets/custom/scripts/master/logo.png", scaledSize: new google.maps.Size(15, 14) , anchor: new google.maps.Point(15, 12)});
             markers.push(marker);
             var infowindow= new google.maps.InfoWindow({
                 content:"<?php echo $a->poklahsar_nama; ?><?php echo $a->pemilik; ?>",
      ...
      $('#btn_cari').click(function(e) {
      	e.preventDefault();
      	var rom = $('input[name="asal"]').val();
      	var to = $('input[name="tujuan"]').val();
