            ...
            <div class="col-md-12">
                ...
                <div class="portlet light bordered">
                    <div class="portlet-title">
                        ...
                        <div class="tools">
                            <?php if (in_array('xcreate_usergroup', $ar_haklistakses)): ?>
...
function btn_delete(id) {
    $.post('<?php echo site_url() ?>usergroup/cek_paten', {id:id}, function(res) {
        if (res.stat) {
            $(".portlet").LoadingOverlay("hide");
            swal(
                {
                    title: "Dilarang!",
                    text: "User Group telah dipatenkan!",
                    type: "warning",
